...
export default function Index(): React.JSX.Element {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            setIsLoading(true);
            await managerLogIn(userId, password);

            // navigate to home
            window.location.href = ROUTES.MANAGER_HOME;
        } catch (error: unknown) {
                ...
                <div className="flex w-[75%] h-[70%] bg-white shadow-lg">
                    ...
                    <div className="flex flex-col w-1/2 items-center justify-center">
                        <div className="w-[75%]">
                            ...
                            <h3 className="mb-10">Country Manager Login</h3>
                        </div>
                        ...
                        >
                            ...
                            <div className="w-full flex flex-col gap-2">
                                ...
                                <p>Not manager? <a className="underline text-blue-500" href={ROUTES.OWNER_LOGIN}>Login as Owner</a></p>
                            </div>
                        </form>
                    </div>
                </div>
